...
<form class="flex h-screen bg-gray-100" action="index.php?action=avocatInscription" method="post">
   <div class="m-auto">
      <div>
         ...
         <div class="mt-5 bg-white rounded-lg shadow">
            ...
            <div class="px-5 pb-5">
               ...
               <div class="flex">
                  ...
                  <div class="flex-grow"><input name="matricule" placeholder="matricule" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400"></div>
               </div>
            ...
            <div class="px-5 pb-5">
               ...
               <div class="flex">
                  ...
                  <div class="flex-grow"><select name="idspecialite"class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400 ">
                   <?php
                   while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                   
?>
                  <option value="<?= $row["idsp"]?>"><?= $row["label"]?></option>
   <?php
   }
   ?>
                  </select></div>
